...
export const papers = [
  ...
  },
  {
    id: 'autowebglm',
    title: 'AutoWebGLM',
    fullTitle: 'AutoWebGLM: A Large Language Model-based Web Navigating Agent',
    arxiv: '2404.03648',
    arxivUrl: 'https://arxiv.org/abs/2404.03648',
    github: 'https://github.com/THUDM/AutoWebGLM',
    hubPath: './topics/papers/autowebglm/index.html',
    explainerPath: './topics/papers/autowebglm/lab.html',
    labPath: './topics/papers/autowebglm/lab.html',
    thesis: 'A deployable 6B web agent beats GPT-4 when HTML is pruned for observations, trained on a human–AI curriculum, and bootstrapped with DPO + rejection sampling.',
    prerequisites: [
      { label: 'Agentic RAG', path: '../../rag/verification-agentic.html' },
      { label: 'DCI (interface design)', path: '../dci-agent/lab.html' },
    ],
    concepts: [],
    journey: {
      phases: [
      ...
      labSections: [
        ...
        { id: 'understand-vocab', label: 'Vocabulary', anchor: '#understand-vocab' },
        { id: 'paradigm', label: 'Paradigm', anchor: '#paradigm' },
        { id: 'granularity', label: 'HTML zoom', anchor: '#granularity' },
        { id: 'compare', label: 'GPT-4 vs AutoWebGLM', anchor: '#compare' },
        { id: 'topk', label: 'Top-k', anchor: '#topk' },
        { id: 'context', label: 'Observation', anchor: '#context' },
        { id: 'curriculum', label: 'Curriculum', anchor: '#curriculum' },
        { id: 'evidence', label: 'Evidence lens', anchor: '#evidence' },
        { id: 'assumptions', label: 'Assumptions', anchor: '#assumptions' },
        { id: 'ideas', label: 'Ideas workshop', anchor: '#ideas' },
        { id: 'chat', label: 'Paper chat', anchor: '#chat' },
      ...
      partGroups: [
        ...
        },
        {
          ...
          sections: [
            { id: 'paradigm', label: 'Paradigm', anchor: '#paradigm' },
            { id: 'granularity', label: 'HTML zoom', anchor: '#granularity' },
            { id: 'compare', label: 'Compare', anchor: '#compare' },
            { id: 'topk', label: 'Top-k', anchor: '#topk' },
            { id: 'context', label: 'Observation', anchor: '#context' },
            { id: 'curriculum', label: 'Curriculum', anchor: '#curriculum' },
            { id: 'evidence', label: 'Evidence lens', anchor: '#evidence' },
      ...
      readinessChecks: [
        ...
        },
        {
          id: 'verify-lab',
          label: 'Used core verify labs',
          hint: 'Interact with paradigm, HTML zoom, and compare',
        },
        {
          id: 'stress-assumptions',
          label: 'Explored assumption scenarios',
