...
export const papers = [
  {
    ...
    journey: {
      ...
      labSections: [
        ...
        { id: 'studio', label: 'Extension studio', anchor: '#studio' },
      ...
      readinessChecks: [
        ...
        { id: 'extend-hypothesis', label: 'Wrote hypotheses for ≥2 extension prompts', storageKey: 'dci-ready-extend', minCount: 2 },
      ],
    },
  },
];
